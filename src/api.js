...
const api = [
  ...
  // 歌单下音乐列表
  { url: proxy + '/plist/list', link: 'http://m.kugou.com/plist/list/{specialid}', method: 'GET', linkKey: 'specialid' },
  // 音乐排行榜
  ...
  // 歌手列表
  { url: proxy + '/singer/list', link: 'http://m.kugou.com/singer/list/{classid}', method: 'GET', linkKey: 'classid' },
  // 歌手信息
  { url: proxy + '/singer/info', link: 'http://m.kugou.com/singer/info/{singerid}', method: 'GET', linkKey: 'singerid' },
  // 歌曲详情
